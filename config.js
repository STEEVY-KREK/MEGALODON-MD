...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~XN8xgKJR#mLHTMmlzu2CdnSThVTAz__wXJp6zkeJMQpVi37fOppg",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50937844273",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "𒋲𝐘𝚫𝐊𝐔𝚭𝚫𓍝⸸𝑉𝑎𝑙ℎ𝑎𝑙𝑙𝑎⸸☠︎¹⁶⁰⁷𓆩",           // Owner's name
    
    DEV: process.env.DEV || "50939130904",                     // Developer's contact number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𒋲𝐘𝚫𝐊𝐔𝚭𝚫𓍝⸸𝑉𝑎𝑙ℎ𝑎𝑙𝑙𝑎⸸☠︎¹⁶⁰⁷𓆩",     // Sticker pack name
